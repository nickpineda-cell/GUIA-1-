...
function aleatorio(minimo, maximo, cantidad){
    ...
    //Verificar que no se haya llegado a la cantidad //Verificar que no se haya llegado a la cantidad
    //de números aleatorios máximo establecidos//de números aleatorios máximo establecidos
    if(aleatorios.length < cantidad){
    //Agregar el número aleatorio al arreglo o 
