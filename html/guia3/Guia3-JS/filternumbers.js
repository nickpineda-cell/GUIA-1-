...
function showChar(e){
    ...
    if (e.keyCode) code = e.keyCode; //Todos los navegadores menos Netsca pe 4.0 o inferior
    else if (e.which) code = e.which; //Netscape 4.0 o inferior
    var character = String.fromCharCode(code);
    //alert('La tecla presionada fue: ' +
    }
    // Dejar pasar únicamente números enteros y bloquear cualquier otra ca
    racter
