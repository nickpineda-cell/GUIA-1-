...
document.write("<h1 align='center'>Encuesta para determinar cuántas personas están afavor de la portabilidad numérica de teléfonos celulares.</h1><hr>");
...
with(document){
 ...
 write("<tr><td>Se abstienen de opinar </td><td class=\"number\">" + cont3 +
"</td>");
