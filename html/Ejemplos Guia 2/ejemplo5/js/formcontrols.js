...
function createform(control, numero){
 ...
 htmlform += "<fieldset>\n";
 htmlform += "<legend><span class=\"number\">1</span> Formulariodinámico</legend>";
 ...
 case "textarea":
 for(i=0; i<numero; i++){
 tag = "<textarea name=\"" + control + (i+1) + "\" requiredplaceholder=\"Ingrese los datos en el campo " + control + "\"></textarea><br />\n";
 htmlform += tag;
 }
 break;
 case "checkbox":
