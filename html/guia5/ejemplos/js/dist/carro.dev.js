...
function iniciar() {
  ...
  var button = document.getElementById("enviar"); //Al producirse en evento change en el elemento select
...
marcas["Honda"] = ["Civic", "Acura", "Accord", "Fit", "Odyssey", "CRV", "Pilot", "RidgeLine"];
marcas["Mitsubishi"] = ["Lancer", "Galant", "Eclipse", "Montero", "Nativa", "Outlander", "L200"]; //Creando el objeto carro con el constructor Object()

var carro = new Object(); //Propiedades del objeto

carro.fabricante = "";
carro.modelo = "";
carro.color = "";
carro.anio = ""; //Métodos del objeto
