...
function iniciar() {
  var btnenviar = document.getElementById("btnSend"); //Al producirse un click sobre el botón de envío
  ...
  if (btnenviar.addEventListener) {
    btnenviar.addEventListener("click", function () {
      ...
      selvalue = document.frmmat.seldegree.options[frmmat.seldegree.selectedIndex].val;
      ue;
      nuevoalumno = new alumnoUDB(document.frmmat.txtname.value, document.frmmat.txtlastname.value, document.frmmat.txtage.value, chkvalue, selvalue);
...
function alumnoUDB(nombre, apellido, edad, genero, carrera) {
  ...
  this.numCarnet = null; //Métodos de la clase
